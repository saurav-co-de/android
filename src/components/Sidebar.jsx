...
const Sidebar = ({ programs, activeId, setActiveId, searchQuery, setSearchQuery, isOpen, setIsOpen }) => {
    return (
        <div className={`fixed inset-y-0 left-0 z-40 w-72 bg-white/70 dark:bg-gray-800/70 backdrop-blur-md border-r border-gray-200/50 dark:border-gray-700/50 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
